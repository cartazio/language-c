...
float, for, goto,
if, inline @__, int, __int128, long, noreturn _Noreturn, _Nullable __nullable,
...
-}
-- Tokens: __alignof alignof __alignof__ __asm asm __asm__ auto break _Bool case char __const const __const__ continue _Complex __complex__ default do double else enum extern float for goto if __inline inline __inline__ int __int128 long _Noreturn _Nullable __nullable _Nonnull __nonnull register __restrict restrict __restrict__ return short __signed signed __signed__ sizeof static struct switch typedef __typeof typeof __typeof__ __thread union unsigned void __volatile volatile __volatile__ while __label__ __attribute __attribute__ __extension__ __real __real__ __imag __imag__ __builtin_va_arg __builtin_offsetof __builtin_types_compatible_p
